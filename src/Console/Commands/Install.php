...
class Install extends Command
{
     ...
     * @var string
     */
    protected string $signature = 'module-generator:install';
     ...
     * @var string
     */
    protected string $description = 'Install the Laravel Module Generator package and optionally generate the Auth Module';
